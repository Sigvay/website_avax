...
def export_avito(data):
    ...
    for result in results.json():
        ...
        ET.SubElement(ad, "Description").text = etr.CDATA(str(
            ...
            f"ЦЕНА УКАЗАНА ЗА {result['ЗАПЧАСТЬ']} В СБОРЕ, В КОМПЛЕКТАЦИИ КАК НА ФОТО!<br />"+
            ...
            "Вы можете связаться с нами по следующим контактам: <br />"+
            "Адрес: Беларусь, Минская область, Узденский район, Озерский сельсовет, агрогородок Озеро, Институтский переулок, 2/2 <br />"+
            "Телефоны: +375 (29) 675-44-36, +375 (29) 311-83-35, +375 (29) 675 44 36<br /><br />"+
            f"<strong>Данный {result['ЗАПЧАСТЬ']} находится на складе в Республике Беларусь</strong><br />"+
