...
def export_avito(data):
    ...
    for result in results.json():
        ...
        ET.SubElement(ad, "Description").text = etr.CDATA(str(
            ...
            f"<strong>Цена указана за {result['ЗАПЧАСТЬ']} в сборе, в комплектации как на фото!</strong><br /><br />"+
            ...
            "Адрес склада: Беларусь, Минская область, Узденский район, Озерский сельсовет, агрогородок Озеро, Институтский переулок, 2/2 <br />"+
